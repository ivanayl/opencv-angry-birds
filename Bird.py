...
class RedBird(Bird):
    def __init__(self, mode, x, y):
        ...
        self.image = mode.loadImage("redbird.png")
        self.w, self.h = self.image.size
        self.flyImage = mode.loadImage("red bird fly.png")
        self.collideImage = mode.loadImage("red bird collide.png")

class YellowBird(Bird):
    def __init__(self, mode, x, y):
        super().__init__(mode, x, y)
        self.image = self.mode.loadImage("yellow bird.png")
        self.w, self.h = self.image.size
        self.flyImage = self.mode.loadImage("yellow bird fly.png")
        self.collideImage = self.mode.loadImage("yellow bird collided.png")
        self.powerImage = self.mode.loadImage("yellow bird fast.png")
        self.mass = 9
...
class Metal(Obstacle):
    def __init__(self, mode, x0, y0, tier, imageUrl, objectBelow = None):
        ...
        self.mass = 10
        self.health = 10
        self.fallImg = self.mode.loadImage("flat metal.png")
...
class Wood(Obstacle):
    def __init__(self, mode, x0, y0, tier, imageUrl, objectBelow = None):
        ...
        self.mass = 7
        self.health = 5
        self.fallImg = self.mode.loadImage("flat wood.png")
